                ...
                <div className="flex flex-1 flex-col gap-6">
                    ...
                    {advertisements.length > 0 ? (
                        ...
                        <div className="relative overflow-hidden rounded-[2.5rem] bg-background/50 backdrop-blur-2xl border border-dashed border-border/40 p-12 lg:p-20 text-center flex flex-col items-center gap-8">
                            ...
                            <Button className="bg-foreground text-background hover:bg-foreground/90 font-black px-12 h-14 rounded-2xl shadow-xl transition-all hover:scale-105" asChild>
                                <Link href={services.index.url()} className="cursor-pointer">Browse All Services</Link>
                            </Button>
                        </div>
                    )}
                    ...
                    <Card className="overflow-hidden border-border/40 bg-background/50 shadow-sm backdrop-blur-sm rounded-2xl">
                        <CardHeader className="flex flex-row items-center justify-between pb-3 border-b border-border/40">
                            ...
                            <Link
                                href="/track-order"
                                className="text-sm font-bold text-bm-gold hover:underline flex items-center gap-1 transition-all hover:translate-x-1 cursor-pointer"
                            >
                                Track Order
                        ...
                        <CardContent className="p-0">
                            {activeWorkOrders.length > 0 ? (
                                    ...
                                    {activeWorkOrders.map((order) => (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <Button size="icon" variant="ghost" className="size-8 rounded-lg hover:bg-bm-gold/10 hover:text-bm-gold transition-all cursor-pointer">
                                ...
                                <div className="p-12 text-center flex flex-col items-center gap-3">
                                    ...
                                    <Button variant="outline" size="sm" className="mt-2 rounded-xl text-xs cursor-pointer">
                                        Request Service
                                    </Button>
                                </div>
                            )}
